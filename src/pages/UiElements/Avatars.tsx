...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Tescam - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Tescam - React.js Tailwind CSS Admin Dashboard Template"
      />
